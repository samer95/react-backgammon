...
class Menu extends Component {
  ...
  getMenu = gameStatus => {
    ...
    content.body = (
        <p className="modal-body-centralized" style={{ fontSize: 30 }}>
          This is backgammon game created By Semir Lehluh
        </p>
    );
    content.footer = this.getRegularFooter();
    content.width = 'menu-small';
    content.canClose = gameStatus !== 80;
    ...
    content.body = (
        <div>
          ...
          <p className="modal-body-centralized">
            {gameStatus === 60 ? players.p1 : players.p2} wins!
          </p>
        </div>
    )
    content.footer = this.getRegularFooter();
